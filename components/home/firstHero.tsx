...
export default function firstHeroHome() {
  ...
  const heroBackgroundStyle = { 'background': `url("https://images.pexels.com/photos/411207/pexels-photo-411207.jpeg?cs=srgb&dl=pexels-sebastian-voortman-411207.jpg&fm=jpg") no-repeat center center fixed`, 
