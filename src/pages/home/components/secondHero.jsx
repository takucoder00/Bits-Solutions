            ...
            <div className="flex flex-wrap items-center sm:-mx-3">
                ...
                <div className="w-full md:w-1/2">
                    <div className="w-full h-80 overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img class="md:flex-shrink-0" alt="" src="https://images.pexels.com/photos/7172814/pexels-photo-7172814.jpeg?cs=srgb&dl=pexels-nataliya-vaitkevich-7172814.jpg&fm=jpg"/>
                    </div>
                </div>
            </div>
        </div>
