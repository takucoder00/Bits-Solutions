    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-wrap md:text-left text-center order-first">
        ...
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav className="list-none mb-10">
            <li>
              <a href="#services" className="text-gray-600 hover:text-gray-800">Solutions</a>
            </li>
            <li>
              <a href="#services" className="text-gray-600 hover:text-gray-800">Marketing</a>
            </li>
            <li>
              <a href="#services" className="text-gray-600 hover:text-gray-800">Networking</a>
            </li>
            <li>
              <a href="#services" className="text-gray-600 hover:text-gray-800">Branding</a>
            </li>
            <li>
              <a href="#services" className="text-gray-600 hover:text-gray-800">Branding & Support</a>
            </li>
          </nav>
        </div>
        <div class="px-4 mt-8 sm:w-1/2 md:w-1/4 xl:w-1/6 md:mt-0">
                    <h5 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">SAY HELLO</h5>
                    ...
                    <div class="mt-3">
                        <div class="">
                            ...
                            <a href="telephone:+263713007044" class="block border-b border-transparent border-solid hover:border-orange-800 hover:text-orange-800">+263 71 300 7044</a>
                            <a href="mailto:info@bs.co.zw" class="block border-b border-transparent border-solid hover:border-orange-800 hover:text-orange-800">info@bitssolutions.co.zw</a>
                        </div>
                        <div class="mt-3">
